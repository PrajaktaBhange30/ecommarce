...
import com.prajakta.ecommerce.security.SecurityUtils;
...
public class AuthServiceImpl implements AuthService {
    ...
    public UserResponseDto register(UserRequestDto userResquestDto) {
        ...
        user.setRoles(EnumSet.of(RoleType.CUSTOMER));
    ...
    public JwtResponseDto login(LoginRequestDto loginRequestDto) {
        ...
        Set<RoleType> roles = SecurityUtils.extractRolesFromAuthorities(userDetails.getAuthorities());
        ...
        responseDto.setRoles(roles.stream()
                .map(RoleType :: name).collect(Collectors.toSet()));
    ...
    public JwtResponseDto adminLogin(LoginRequestDto loginRequestDto) {
        ...
        responseDto.setToken(token);
        responseDto.setEmail(userDetails.getUsername());
        responseDto.setRoles(roles.stream().map(RoleType :: name).collect(Collectors.toSet()));
